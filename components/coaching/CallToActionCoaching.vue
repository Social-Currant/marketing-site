<template>
  <div class="cta-container flex items-center mt-[32px] flex-col py-8 md:py-16 lg:py-28">
    <div class="cta-title">
...
<style scoped>
.cta-container{
    background: linear-gradient(129deg, rgba(199, 214, 250, 0.75) 20.12%, #D5C2E7 100%);
}
.cta-title{
color: #30104C;
text-align: center;
...
@media (max-width: 768px) {.cta-title{
  font-size: 24px;
}}
</style>